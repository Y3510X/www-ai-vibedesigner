...
At age 8--10, the author witnessed a deer being killed, gutted, and prepared over an open fire. Staring at a burning log beside the scene, a clear intuition formed: the unburned wood ahead of the flames represented the future, the charred remains behind represented the past, and the thin moving flame front was the present. Crucially, the entire log continued to exist as a whole; nothing was destroyed, only transformed at the moving interface. This visceral realization—that the whole structure coexists and the ``flow'' of time is merely the position of the active front—has shaped the author's view of time and consciousness ever since.
